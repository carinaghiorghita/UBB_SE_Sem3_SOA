...
export default class CardPaymentPage extends React.Component {
    ...
    handleSubmit = e => {
        ...
        BookService.findBookById(id).then(book =>{
            var order = new Order(UserService.currentUserValue.id, book.data);
            BookService.createOrder(order).then(data => {
                this.setState({infoMessage: 'You bought the book successfully.'});
